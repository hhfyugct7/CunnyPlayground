...
- `android.permission.POST_NOTIFICATIONS` - Required for sending notifications
- `android.permission.POST_PROMOTED_NOTIFICATIONS` - Required for sending promoted (isOngoing) notifications
- `android.permission.USE_FULL_SCREEN_INTENT` - Required for sending full screen intent notifications
- `android.permission.FOREGROUND_SERVICE` - Required for sending foreground service notifications
- `android.permission.FOREGROUND_SERVICE_SPECIAL_USE` - Required for sending foreground service special use notifications
- `android.permission.QUERY_ALL_PACKAGES` - Required for querying all packages
